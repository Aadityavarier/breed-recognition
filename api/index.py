...
# 3. Predict Endpoints (Catches all scan requests)
...
# 4. Catalog / Encyclopedia Endpoints
...
def catalog():
    breeds_data = [
        {"name": "Gir", "breed": "Gir", "category": "Indigenous Cattle", "origin": "Gujarat", "milk_yield": "2000-3000 kg", "features": "Convex forehead, pendulous ears, half-curved horns", "image_url": "/static/images/gir.jpg"},
        {"name": "Sahiwal", "breed": "Sahiwal", "category": "Indigenous Cattle", "origin": "Punjab / Rajasthan", "milk_yield": "2500-3200 kg", "features": "Reddish brown coat, loose skin, docile demeanor", "image_url": "/static/images/sahiwal.jpg"},
        {"name": "Murrah", "breed": "Murrah", "category": "Indigenous Buffalo", "origin": "Haryana / Punjab", "milk_yield": "2200-3500 kg", "features": "Jet black coat, tightly curled horns, large udder", "image_url": "/static/images/murrah.jpg"},
        {"name": "Red Sindhi", "breed": "Red Sindhi", "category": "Indigenous Cattle", "origin": "Sindh / Gujarat", "milk_yield": "1800-2600 kg", "features": "Deep red color, compact body, distinctive hump", "image_url": "/static/images/red_sindhi.jpg"},
        {"name": "Kankrej", "breed": "Kankrej", "category": "Indigenous Cattle", "origin": "Gujarat / Rajasthan", "milk_yield": "1400-2200 kg", "features": "Lyre-shaped horns, silver-grey coat, powerful build", "image_url": "/static/images/kankrej.jpg"},
        {"name": "Jaffrabadi", "breed": "Jaffrabadi", "category": "Indigenous Buffalo", "origin": "Gujarat", "milk_yield": "2500-3000 kg", "features": "Prominent forehead, drooping flat horns, heavy body", "image_url": "/static/images/jaffrabadi.jpg"}
    ]
    return jsonify({"success": True, "breeds": breeds_data, "data": breeds_data, "catalog": breeds_data, "items": breeds_data})
...
def queue():
    ...
    return jsonify({"success": True, "queue": queue_items, "data": queue_items, "scans": queue_items, "items": queue_items})
...
def audit():
    ...
    return jsonify({"success": True, "audit": audit_data, "logs": audit_data, "data": audit_data, "scans": audit_data, "items": audit_data})

# 7. Action / Verification Endpoints
@app.route("/api/verify", methods=["POST", "GET"])
@app.route("/verify", methods=["POST", "GET"])
def verify():
    return jsonify({"success": True, "message": "Record confirmed and synchronized."})

# 8. Universal JSON Catch-All (Prevents HTML <!doctype> from ever breaking fetch calls)
